...
templates['book'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"col s12 m3\">\n    <div class=\"card\">\n      <div class=\"card-image\">\n        <img class=\"book-cover\" src=\""
    ...
    + "</p>\n          <p><b> Read? </b></p>\n          <p>"
    + alias4(((helper = (helper = helpers.read || (depth0 != null ? depth0.read : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"read","hash":{},"data":data}) : helper)))
    + "</p>\n      </div>\n    </div>\n  </div>\n";
